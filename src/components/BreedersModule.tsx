  ...
  return (
    <div className=\"space-y-6\">
      <div className=\"flex justify-between items-center text-white\">
        <div>
          <h3 className=\"text-2xl font-display font-bold\">Reproductores Elite</h3>
          <p className=\"text-[10px] text-slate-500 uppercase tracking-widest font-bold\">Seguimiento Individual de Ejemplares</p>
        </div>
        <Button 
      ...
      {showForm && (
        <Card className=\"animate-in fade-in slide-in-from-top-4 duration-300 border-white/10 bg-white/5\">
          <form onSubmit={handleSubmit} className=\"space-y-4\">
            ...
            <Button type=\"submit\" className=\"w-full h-10 font-bold uppercase text-[10px] bg-aqua-400 text-slate-950\">Registrar Reproductor</Button>
          </form>
        </Card>\n      )}
