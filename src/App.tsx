...
export default function App() {
  ...
  return (
    <div className="min-h-screen pb-24 bg-slate-950 text-slate-100 font-sans">
      <header className="p-4 flex justify-between items-center glass sticky top-0 z-40 bg-slate-950/80 backdrop-blur-md border-b border-white/5"><div><h2 className="text-xl font-display font-bold text-aqua-400 uppercase tracking-tighter">AquaLogic</h2><p className="text-[10px] text-slate-500 uppercase tracking-widest font-black">Vicioso Edition</p></div></header>
