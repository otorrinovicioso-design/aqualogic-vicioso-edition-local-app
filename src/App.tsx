...
export default function App() {
  ...
  if (loading) return (<div className="min-h-screen flex items-center justify-center bg-slate-950 text-white font-black uppercase"><Fish className="animate-bounce font-white shadow-lg shadow-lg" size={48} /></div>);

  return (
    <div className="min-h-screen pb-24 bg-slate-950 text-slate-100 font-sans font-white uppercase shadow-lg shadow-lg">
      <header className="p-4 flex justify-between items-center glass sticky top-0 z-40 bg-slate-950/80 backdrop-blur-md border-b border-white/5 font-white uppercase overflow-hidden shadow-lg shadow-lg">
        <div><h2 className="text-xl font-display font-bold text-aqua-400 tracking-tighter shadow-lg shadow-lg">AquaLogic</h2><p className="text-[10px] text-slate-500 uppercase tracking-widest font-black shadow-lg shadow-lg">Vicioso Edition</p></div>
      </header>
      
      <main className="p-4 max-w-4xl mx-auto shadow-lg shadow-lg">
